...
public class Safaricom extends ActionBarActivity {
    private static final String TAG = MainActivity.class.getSimpleName();
    RelativeLayout relative1;
    // Movies json url
    private static final String url = "http://softtech.comuv.com/nick/safaricom.js";
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_safaricom, menu);
        return true;
    }
